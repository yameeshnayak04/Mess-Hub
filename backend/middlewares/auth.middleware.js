...
const protect = async (req, res, next) => {
  ...
  if (req.headers.authorization && req.headers.authorization.startsWith('Bearer')) {
    try {
      ...
      // 4. If verification is successful, find the user from the token's payload.
      // We explicitly exclude sensitive fields like otp and the hashed pin.
...
// --- Role-Based Middleware (to be used AFTER the 'protect' middleware) ---
